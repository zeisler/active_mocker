...
describe 'Comparing ActiveMocker Api to ActiveRecord Api' do
  ...
  describe '::where' do
    ...
    context 'will return all if no options passed' do
      ...
      it 'UserMock' do
        where_no_options(UserMock, ActiveMocker::Mock::Queries::WhereNotChain)
      end
  ...
  describe 'CollectionAssociation' do
    ...
    context 'supported array methods' do
      ...
      it 'UserMock' do
        supported_array_methods(UserMock, MicropostMock, ActiveMocker::Mock::HasMany)
      end
    ...
    describe '#find' do
      ...
      context 'single id passed' do
        ...
        it 'UserMock' do
          collection_find(UserMock, MicropostMock, ActiveMocker::Mock::Association)
        end
      ...
      context 'multiple ids passed' do
        ...
        it 'UserMock' do
          collection_finds(UserMock, MicropostMock, ActiveMocker::Mock::Association)
        end
  ...
  describe '::find_by!' do
    ...
    context 'will raise exception if not found' do
      ...
      it 'UserMock' do
        find_by_exception(UserMock, ActiveMocker::Mock::RecordNotFound)
      end
