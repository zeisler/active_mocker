...
#
# describe ActiveMock::Records do
#
...
#         expect{subject.insert(new_record)}.to raise_exception(ActiveMock::IdError, 'Duplicate ID found for record {:id=>1}')
#       end
#
#     end
#
...
#       subject = described_class.new
#       expect{subject.delete(record)}.to raise_error(ActiveMock::RecordNotFound, 'Record has not been created.')
#     end
#
#   end
#
